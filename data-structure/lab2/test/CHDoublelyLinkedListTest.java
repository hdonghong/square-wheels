import impl.CHDoublelyLinkedList;
import impl.LList;
import org.junit.Assert;
import org.junit.Test;

public class CHDoublelyLinkedListTest {

    @Test
    public void isEmpty() throws Exception {
        LList<String> list = new CHDoublelyLinkedList<>();
    ...
    public void addAll() throws Exception {
        ...
        LList<String> list2 = new CHDoublelyLinkedList<>();
        list2.insert("a");
        list2.insert("b");
        list2.insert("c");
